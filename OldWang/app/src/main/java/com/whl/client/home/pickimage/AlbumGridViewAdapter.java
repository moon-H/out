...
public class AlbumGridViewAdapter extends BaseAdapter {
    ...
    private ArrayList<TempImageItem> selectedDataList;
    private DisplayMetrics dm;
    BitmapCache cache;

    public AlbumGridViewAdapter(Context c, ArrayList<TempImageItem> dataList, ArrayList<TempImageItem> selectedDataList) {
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (path.contains("camera_default")) {
            ...
            final TempImageItem item = dataList.get(position);
