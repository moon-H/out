    ...
    private void getAlbumColumnData(Cursor cur) {
        if (cur.moveToFirst()) {
            ...
            do {
                ...
                // Do something with the values.
                MLog.i(TAG, _id + " album:" + album + " albumArt:" + albumArt + "albumKey: " + albumKey + " artist: " + artist + " numOfSongs: " + numOfSongs + "---");
                HashMap<String, String> hash = new HashMap<String, String>();
                hash.put("_id", _id + "");
    ...
    void buildImagesBucketList() {
        ...
        if (cur != null) {
            if (cur.moveToFirst()) {
                ...
                do {
                    ...
                    bucket.count++;
                    TempImageItem imageItem = new TempImageItem();
        ...
        while (itr.hasNext()) {
            ...
            for (int i = 0; i < bucket.imageList.size(); ++i) {
                TempImageItem image = bucket.imageList.get(i);
