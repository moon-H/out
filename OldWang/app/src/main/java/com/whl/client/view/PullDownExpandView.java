...
import com.whl.client.view.ScrollOverExpandListView.OnScrollOverListener;
...
public class PullDownExpandView extends LinearLayout implements
	...
	private View line;
	private ScrollOverExpandListView mListView;
	...
	private void initHeaderViewAndFooterViewAndListView(Context context) {
		...
		mListView = new ScrollOverExpandListView(context);
	...
	public boolean onMotionUp(MotionEvent ev) {
		if (ScrollOverExpandListView.canRefleash) {
			ScrollOverExpandListView.canRefleash = false;
