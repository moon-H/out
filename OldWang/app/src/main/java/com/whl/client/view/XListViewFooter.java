...
public class XListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {// 上拉加载更多
			...
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.pulldown_loading);// 加载中
		}else if(state == STATE_OVER){//没有更多的时候
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.xlistview_footer_hint_over);// 没有更多
		}else {
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.pulldown_footer_text);// 上拉加载更多
		}
	}
