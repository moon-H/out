 ...
 * {@link SimpleFloatViewManager}, which provides basic float OrderView
 * creation.
 * <p/>
...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
     ...
     *
     * @param dslv         The DSLV instance
     * @param dragHandleId The resource id of the OrderView that represents
    ...
    /**
     * Set the resource id for the OrderView that represents the drag
    ...
    /**
     * Set the resource id for the OrderView that represents the fling
     * handle in a list item.
     *
     * @param id An android resource id.
     */
    ...
    /**
     * Set the resource id for the OrderView that represents click
     * removal button.
     *
     * @param id An android resource id.
     */
    ...
    /**
     * Sets flags to restrict certain motions of the floating OrderView
     * based on DragSortController settings (such as remove mode).
     * Starts the drag on the DragSortListView.
     *
     * @param position The list item position (includes headers).
     * @param deltaX   Touch x-coord minus left edge of floating OrderView.
     * @param deltaY   Touch y-coord minus top edge of floating OrderView.
