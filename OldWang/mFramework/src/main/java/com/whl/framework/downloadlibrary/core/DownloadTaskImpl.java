package com.whl.framework.downloadlibrary.core;


import android.text.TextUtils;

import com.whl.framework.downloadlibrary.DownloadConstants;
import com.whl.framework.downloadlibrary.CssDownloadInfo;
import com.whl.framework.downloadlibrary.DownloadException;
import com.whl.framework.downloadlibrary.architecture.DownloadStatus;
import com.whl.framework.downloadlibrary.architecture.DownloadTask;
import com.whl.framework.downloadlibrary.db.ThreadInfo;
import com.whl.framework.downloadlibrary.util.IOCloseUtils;
...
public abstract class DownloadTaskImpl implements DownloadTask {
    ...
    private final CssDownloadInfo mDownloadInfo;
    ...
    public DownloadTaskImpl(CssDownloadInfo downloadInfo, ThreadInfo threadInfo, OnDownloadListener listener) {
    ...
    private void executeDownload() throws DownloadException {
        ...
        try {
            ...
            httpConnection.setConnectTimeout(DownloadConstants.CONNECT_TIME_OUT);
            httpConnection.setReadTimeout(DownloadConstants.READ_TIME_OUT);
            httpConnection.setRequestMethod(DownloadConstants.GET);
