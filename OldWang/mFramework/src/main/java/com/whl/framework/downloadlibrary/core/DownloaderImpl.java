...
import com.whl.framework.downloadlibrary.architecture.ConnectTask;
 ...
 */
public class DownloaderImpl implements CssDownloader, ConnectTask.OnConnectListener, DownloadTask.OnDownloadListener {
    ...
    private CssDownloadInfo mDownloadInfo;
    ...
    private void init() {
        mDownloadInfo = new CssDownloadInfo(mRequest.getTitle().toString(), mRequest.getUri(), mRequest.getFolder());
